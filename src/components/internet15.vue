<template>
  <Common
    ...
    imgButtom="/images/校园网15/15.上网2022illustration.png"
    title="你与校园网"
    resource="数据来源：信息化办"
    isContain="1"
  >
    <ul>
      ...
      <li><span class="collageHighlight sizeHighlight">软件工程学院</span></li>
    </ul>
  </Common>
</template>
...
const {data:{yx,swzsc,wx}}=await  request("/myterm/network",{})
</script>
