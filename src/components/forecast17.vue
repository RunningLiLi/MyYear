    ...
    <div class="textContainer">
      ...
      <template v-if="data">
        <ul>
          ...
          <li>运用机器学习算法，预测学生本学期的学业情况。</li>
          <li>根据往届学长学姐的消费和学业等相关数据建模，</li>
          <li>结合你自身这一学年的数据，</li>
          <li>运用机器学习算法，预测您本学期的学业情况，</li>
        </ul>
        <ul v-if="data * 1 > 0.5">
          <li>你有{{data*100}}%的概率挂科，</li>
          <li>你站在学业预警的边缘，要加强学习哦！</li>
          <li>只要复习早，挂科风险小</li>
        </ul>
        <ul v-else-if="data * 1 < 0.5&&data * 1 > 0.2">
          <li>你有{{data*100}}%的概率挂科，</li>
          <li>要加强学习哦！</li>
          <li>只要复习早，挂科风险小</li>
        </ul>
        <ul v-else-if="data * 1 < 0.2&&data * 1 > 0.1">
          <li>你有{{data*100}}%的概率挂科，</li>
          <li>你的学习状态很好，要继续保持，加油哦！</li>
          <li>只要复习早，挂科风险小</li>
        </ul>
        <ul v-else-if="data * 1 < 0.1&&data * 1 > 0">
          <li>你有{{data*100}}%的概率挂科，</li>
          <li>你就是传说中的“大神”，</li>
          <li>你的学习状态非常好，要继续保持，加油哦！</li>
        </ul>
      </template>
      <template v-else>
          <ul>
...
.triangle2 {
  ...
  height: 0;
  width: 0;
  border-top: 0.8vh solid rgb(255, 255, 255);
...
.triangle {
  ...
  top: 2vh;
  transform: translateX(-50%);
  border: 2.5vh solid purple;
  height: 0;
  width: 0;
  border-top: 2.2vh solid rgb(151, 114, 243);
  border-right: 2.3vh solid transparent;
  border-left: 2.3vh solid transparent;
  border-bottom: 2.3vh solid transparent;
}
.tips {
  position: absolute;
...
.container {
  ...
  width: 100%;
  height: 100%;
  background: url("../asset/学业预测17/17.学业预测2022bg.jpg");
